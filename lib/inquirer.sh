...
_list_input() {
  ...
  on_keypress on_list_input_up on_list_input_down on_list_input_enter_space on_list_input_enter_space on_default on_default on_list_input_ascii
